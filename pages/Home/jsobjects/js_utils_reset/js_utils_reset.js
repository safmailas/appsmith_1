export default {
	reset_store: async(resetValues) => {
		...
		const reset_store_static = {
			// Demo-mode defaults. Recruiter-friendly: no real Supabase credentials.
			'supabaseUrl': '',
			'supabaseKey': '',
			'demo_mode': true,
			'resetCounter': 0,
			...
			'pin': '080622',
			'photo_url_prefix': 'https://placehold.co/600x400?text=Image',
			'photo_url_reservations_prefix': 'https://placehold.co/300x300?text=Post',
			'photo_url_contacts_prefix': 'https://placehold.co/91x91?text=Avatar',
		};
